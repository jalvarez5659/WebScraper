...
public class StockQueue
{
    ...
    public void buy()
    {
        ...
        OwnedCompany other = new OwnedCompany(thing.getstockPrice(), thing.getpreviousClose(), thing.getinNews(), thing.getnegPublicity(), thing.getposPublicity(), thing.getdirectCompetion(), thing.gettappedMarket(), thing.getname());
        oQueue.add(other);
    ...
    public void sell()
    {
        ...
        Company other = new Company(thing.getstockPrice(), thing.getpreviousClose(), thing.getinNews(), thing.getnegPublicity(), thing.getposPublicity(), thing.getdirectCompetion(), thing.gettappedMarket(), thing.getname());
        sQueue.add(other);
